...
@property (nonatomic, strong) UIView *commentView; //评论的View
@property (nonatomic, strong) UIButton *commentBtn; //评论的button
...
//    [self addSubview:_likeLabel];
    ...
    _likeLableBottomLine.backgroundColor = rgb(234,234,234);
